...
namespace Automation_TrainingM10B.Base_Files
{
    class QueryUtils
    {
        ...
        public void SetAttribute(PropertyInfo converToAttribute, object convertToObject, object convertFromValue)
        {
            converToAttribute.SetValue(convertToObject, convertFromValue);
        }
    }
}
