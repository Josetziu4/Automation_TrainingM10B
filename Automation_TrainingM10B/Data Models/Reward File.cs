...
namespace Automation_TrainingM10B.Data_Models
{
    class Reward_File:ReportManager
    {
        ...
        public void fnCreateFile()
        {
            ...
            {
                file.WriteLine($"{reward.MemberId}|{reward.RewardId}|{reward.RewardName}|{reward.RewardStarDate}|{reward.RewardEndDate}");
            }
            file.Close();
        }
        ...
        /*
         * Header
         * File Name (AUTO_REWARD_YYYYMMDD_HHMMDD_HHMMSS.TXT)
